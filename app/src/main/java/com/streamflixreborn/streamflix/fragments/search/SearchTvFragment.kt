...
class SearchTvFragment : Fragment() {
    ...
    private fun initializeSearch() {
        ...
        binding.tvRecentSearchesLabel.setOnClickListener {
            viewModel.clearHistory()
        }
        binding.tvRecentSearchesLabel.nextFocusDownId = R.id.rv_recent_searches
    ...
    private fun updateSearchHistoryVisibility() {
        ...
        binding.tvRecentSearchesLabel.visibility = if (showHistory) View.VISIBLE else View.GONE

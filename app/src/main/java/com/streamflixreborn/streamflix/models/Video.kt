...
fun List<Video.Server>.best(): Video.Server {
    return this.firstOrNull {
        val n = it.name
        n.contains("1080", ignoreCase = true) || n.contains("FHD", ignoreCase = true)
    } ?: this.firstOrNull {
        val n = it.name
        n.contains("720", ignoreCase = true) || n.contains("HD", ignoreCase = true)
    } ?: this.first()
}

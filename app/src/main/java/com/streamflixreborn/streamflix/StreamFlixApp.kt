...
class StreamFlixApp : Application() {
    ...
    override fun onCreate() {
        ...
        // 2. Create download notification channel
        VideoDownloadService.createChannel(this)

        // 2b. Create auto-backup notification channel
        BackupScheduler.createNotificationChannel(this)

        // 3. Inizializzazione preferenze (con applicationContext)

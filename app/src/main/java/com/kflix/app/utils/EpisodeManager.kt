...
import com.kflix.app.models.Video.Type.Episode
...
object EpisodeManager {
    ...
    fun convertToVideoTypeEpisodes(episodes: List<com.kflix.app.models.Episode>, database: AppDatabase, seasonNumber: Int): List<Episode> {

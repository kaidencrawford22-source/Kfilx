...
import com.kflix.app.databinding.ItemSettingMobileBinding
import com.kflix.app.databinding.ViewPlayerSettingsMobileBinding
import com.kflix.app.utils.dp
import com.kflix.app.utils.margin
                ...
                setOnClickListener {
                    when (item) {
                        ...
                        is Settings.Gestures -> {
                            when (item) {
                                is Settings.Gestures.On -> com.kflix.app.utils.UserPreferences.playerGestures = true
                                is Settings.Gestures.Off -> com.kflix.app.utils.UserPreferences.playerGestures = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
                        ...
                        is Settings.KeepScreenOn -> {
                            when (item) {
                                is Settings.KeepScreenOn.On -> com.kflix.app.utils.UserPreferences.keepScreenOnWhenPaused = true
                                is Settings.KeepScreenOn.Off -> com.kflix.app.utils.UserPreferences.keepScreenOnWhenPaused = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }

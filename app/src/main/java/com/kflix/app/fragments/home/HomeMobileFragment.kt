package com.kflix.app.fragments.home
...
import com.kflix.app.databinding.FragmentHomeMobileBinding
...
import com.kflix.app.utils.LoggingUtils
...
class HomeMobileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            com.kflix.app.utils.ProviderChangeNotifier.providerChangeFlow.flowWithLifecycle(lifecycle, Lifecycle.State.STARTED).collect { viewModel.getHome() }
        }
                ...
                when (state) {
                    ...
                    is HomeViewModel.State.FailedLoading -> {
                        ...
                        if (code == 409 && !hasAutoCleared409) {
                            ...
                            android.widget.Toast.makeText(requireContext(), getString(com.kflix.app.R.string.clear_cache_done_409), android.widget.Toast.LENGTH_SHORT).show()
                            viewModel.getHome()
                            return@collect
                        }
                        Toast.makeText(
                        ...
                        binding.isLoading.apply {
                            ...
                            btnIsLoadingClearCache.setOnClickListener {
                                CacheUtils.clearAppCache(requireContext())
                                android.widget.Toast.makeText(requireContext(), getString(com.kflix.app.R.string.clear_cache_done), android.widget.Toast.LENGTH_SHORT).show()
                                doRetry()
                            }

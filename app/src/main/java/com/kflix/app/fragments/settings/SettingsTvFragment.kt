package com.kflix.app.fragments.settings
...
import com.kflix.app.activities.main.MainTvActivity
import com.kflix.app.backup.BackupRestoreManager
import com.kflix.app.backup.ProviderBackupContext
...
import com.kflix.app.providers.FrenchStreamProvider
import com.kflix.app.providers.Provider
import com.kflix.app.providers.ProviderConfigUrl
import com.kflix.app.providers.ProviderPortalUrl
import com.kflix.app.providers.StreamingCommunityProvider
import com.kflix.app.providers.TmdbProvider
...
import com.kflix.app.utils.ProviderChangeNotifier
import com.kflix.app.utils.QrUtils
import com.kflix.app.utils.ThemeManager
import com.kflix.app.utils.UserDataCache
import com.kflix.app.utils.UserPreferences
import com.kflix.app.utils.WebSocketBypassTestHelper
...
class SettingsTvFragment : LeanbackPreferenceFragmentCompat() {
    ...
    private fun displaySettings() {
        ...
        findPreference<Preference>("key_switch_profile")?.setOnPreferenceClickListener {
            val navHostFragment = activity?.supportFragmentManager?.findFragmentById(R.id.nav_main_fragment) as? androidx.navigation.fragment.NavHostFragment
            navHostFragment?.navController?.navigate(R.id.action_global_profile_picker)
            true
        }

        findPreference<Preference>("key_manage_profiles")?.setOnPreferenceClickListener {
            val navHostFragment = activity?.supportFragmentManager?.findFragmentById(R.id.nav_main_fragment) as? androidx.navigation.fragment.NavHostFragment
            navHostFragment?.navController?.navigate(R.id.action_global_profile_picker)
            true
        }
            ...
            withBackupLoading(R.string.backup_export_title) {
                ...
                runCatching {
                    val values = ContentValues().apply {
                        ...
                        put(MediaStore.Downloads.RELATIVE_PATH, Environment.DIRECTORY_DOWNLOADS + "/Kflix")
                    }
                    ...
                    Toast.makeText(
                        requireContext(),
                        getString(R.string.backup_export_saved_to, "Downloads/Kflix/$fileName"),
                        Toast.LENGTH_LONG
                    ).show()
                }.onFailure { error ->
                    Toast.makeText(requireContext(), getString(R.string.backup_export_error_write), Toast.LENGTH_LONG).show()

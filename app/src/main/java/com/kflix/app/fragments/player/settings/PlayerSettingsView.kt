package com.kflix.app.fragments.player.settings
...
import com.kflix.app.utils.OpenSubtitles
import com.kflix.app.utils.mediaServers
import com.kflix.app.utils.SubDL
import com.kflix.app.utils.UserPreferences
import com.kflix.app.utils.dp
import com.kflix.app.utils.findClosest
import com.kflix.app.utils.getAlpha
import com.kflix.app.utils.getRgb
import com.kflix.app.utils.mediaServerId
import com.kflix.app.utils.mediaServers
import com.kflix.app.utils.setAlpha
import com.kflix.app.utils.setRgb
import com.kflix.app.utils.supportedTrackFormats
        ...
        sealed class Subtitle : Item {
            ...
            sealed class OpenSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(openSubtitles: List<com.kflix.app.utils.OpenSubtitles.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val openSubtitle: com.kflix.app.utils.OpenSubtitles.Subtitle
                ) : OpenSubtitles()
            }
            ...
            sealed class SubDLSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(subDLSubtitles: List<com.kflix.app.utils.SubDL.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val subDLSubtitle: com.kflix.app.utils.SubDL.Subtitle
                ) : SubDLSubtitles()
            }
        }

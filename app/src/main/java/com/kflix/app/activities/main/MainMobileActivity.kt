...
import com.kflix.app.databinding.ActivityMainMobileBinding
import com.kflix.app.fragments.player.PlayerMobileFragment
import com.kflix.app.providers.Cine24hProvider
import com.kflix.app.providers.Provider
import com.kflix.app.ui.UpdateAppMobileDialog
...
class MainMobileActivity : FragmentActivity() {
        ...
        if (savedInstanceState == null) {
            ...
            if (provider != null) {
                lifecycleScope.launch(Dispatchers.IO) {
                    val db = LibraryDatabase.getInstance(this@MainMobileActivity)
    ...
    private fun handleIntent(intent: Intent): Boolean {
        ...
        if (data.scheme == "kflix" && data.host == "resolve") {

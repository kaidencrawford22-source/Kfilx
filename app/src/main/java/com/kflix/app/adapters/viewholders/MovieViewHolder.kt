...
import com.kflix.app.fragments.genre.GenreMobileFragment
import com.kflix.app.fragments.genre.GenreMobileFragmentDirections
import com.kflix.app.fragments.genre.GenreTvFragment
import com.kflix.app.fragments.genre.GenreTvFragmentDirections
import com.kflix.app.fragments.home.HomeMobileFragment
import com.kflix.app.fragments.home.HomeMobileFragmentDirections
import com.kflix.app.fragments.home.HomeTvFragment
import com.kflix.app.fragments.home.HomeTvFragmentDirections
...
import com.kflix.app.fragments.movies.MoviesMobileFragment
import com.kflix.app.fragments.movies.MoviesMobileFragmentDirections
import com.kflix.app.fragments.movies.MoviesTvFragment
import com.kflix.app.fragments.movies.MoviesTvFragmentDirections
import com.kflix.app.fragments.people.PeopleMobileFragment
import com.kflix.app.fragments.people.PeopleMobileFragmentDirections
import com.kflix.app.fragments.people.PeopleTvFragment
import com.kflix.app.fragments.people.PeopleTvFragmentDirections
import com.kflix.app.fragments.search.SearchMobileFragment
import com.kflix.app.fragments.search.SearchMobileFragmentDirections
import com.kflix.app.fragments.search.SearchTvFragment
import com.kflix.app.fragments.search.SearchTvFragmentDirections
...
import com.kflix.app.fragments.tv_shows.TvShowsTvFragment
import com.kflix.app.fragments.tv_shows.TvShowsTvFragmentDirections
import com.kflix.app.models.Movie
import com.kflix.app.models.TvShow
import com.kflix.app.models.Video
import com.kflix.app.models.best
import com.kflix.app.ui.ShowOptionsMobileDialog
import com.kflix.app.ui.ShowOptionsTvDialog
...
import com.kflix.app.utils.loadMovieBanner
import com.kflix.app.utils.loadMoviePoster
import com.kflix.app.utils.ArtworkRepair
...
class MovieViewHolder(
    ...
    companion object {
        ...
        private const val KEY_SMARTTUBE_PACKAGE = "preferred_smarttube_package"
        ...
        fun launchSeal(context: Context, url: String, headers: Map<String, String>?, mimeType: String?) {
    ...
    private fun displayMovieMobile(binding: ContentMovieMobileBinding) {
        ...
        binding.btnMovieAddLibrary.apply {
            fun Boolean.iconRes() = when (this) {
                true -> R.drawable.ic_minus
                false -> R.drawable.ic_plus
            }

            itemView.findViewTreeLifecycleOwner()?.lifecycleScope?.launch(Dispatchers.IO) {
                val libDb = LibraryDatabase.getInstance(context)
                val existing = libDb.libraryItemDao().getByContentId(movie.id)
                val inLibrary = existing != null
                withContext(Dispatchers.Main) {
                    setImageDrawable(
                        ContextCompat.getDrawable(context, inLibrary.iconRes())
                    )
                }
            }
            ...
            setOnClickListener {
                itemView.findViewTreeLifecycleOwner()?.lifecycleScope?.launch(Dispatchers.IO) {
                    val libDb = LibraryDatabase.getInstance(context)
                    val dao = libDb.libraryItemDao()
                    val existing = dao.getByContentId(movie.id)
                    if (existing != null) {
                        dao.delete(movie.id)
                        withContext(Dispatchers.Main) {
                            setImageDrawable(

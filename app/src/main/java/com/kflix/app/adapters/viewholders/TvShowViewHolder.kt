...
import com.kflix.app.databinding.*
...
import com.kflix.app.utils.loadTvShowBanner
import com.kflix.app.utils.loadTvShowPoster
...
class TvShowViewHolder(
    ...
    private fun displayTvShowMobile(binding: ContentTvShowMobileBinding) {
        ...
        binding.btnTvShowAddLibrary.apply {
            ...
            itemView.findViewTreeLifecycleOwner()?.lifecycleScope?.launch(Dispatchers.IO) {
                ...
                val existing = libDb.libraryItemDao().getByContentId(tvShow.id)
            ...
            setOnClickListener {
                itemView.findViewTreeLifecycleOwner()?.lifecycleScope?.launch(Dispatchers.IO) {
                    ...
                    val existing = dao.getByContentId(tvShow.id)
                    if (existing != null) {
                        dao.delete(tvShow.id)
                        withContext(Dispatchers.Main) {
                            setImageDrawable(

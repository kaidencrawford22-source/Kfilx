...
import MyCookieJar
import com.kflix.app.utils.TmdbUtils

object MEGAKinoProvider : Provider {

    override val name = "MEGAKino"
    override val baseUrl = "https://megakino5.org"
    ...
    override suspend fun getGenre(id: String, page: Int): Genre {
        ...
        return Genre(id, genreName, items.filterIsInstance<com.kflix.app.models.Show>())
    }
    ...
    override suspend fun getPeople(id: String, page: Int): People {
        ...
        val filmography = parseContentItems(document).filterIsInstance<com.kflix.app.models.Show>()
